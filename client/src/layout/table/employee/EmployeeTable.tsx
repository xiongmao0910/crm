...
import { CreateEmployeeModal, UpdateEmployeeModal } from "../../../modal";
...
const EmployeeTable = () => {
    ...
    const handleCreate = useCallback(
        async (data: TCreateEmployeeRequest) => {
    ...
    const columns = useMemo<MRT_ColumnDef<TColumn>[]>(() => {
        return [
            ...
            },
            {
                ...
                header: "Giới tính",
                accessorFn: (row) =>
                    gender[row.gioitinh != null ? row.gioitinh : 3],
                muiTableBodyCellProps: () => ({
                    className: "first-letter:uppercase",
                }),
            },
